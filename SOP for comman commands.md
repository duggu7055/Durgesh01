...
6. **Check Resource Usage by Process**
   ...
   htop
   ```
   The `htop` command is an interactive, user-friendly process viewer that displays system resource usage and allows you to manage processes in re
